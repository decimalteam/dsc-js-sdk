...
export default class DecimalEVM {
    ...
    delegateNFT(validator: string, nftAddress: string, tokenId: string | number | bigint, estimateGas?: boolean): Promise<any>;
    delegateNFTHold(validator: string, nftAddress: string, tokenId: string | number | bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    delegateNFTByPermit(validator: string, nftAddress: string, tokenId: string | number | bigint, sign: ethers.Signature, estimateGas?: boolean): Promise<any>;
    withdrawNFT(validator: string, nftAddress: string, tokenId: string | number | bigint, estimateGas?: boolean): Promise<any>;
    withdrawNFTHold(validator: string, nftAddress: string, tokenId: string | number | bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    transferNFTStake(oldValidator: string, nftAddress: string, tokenId: string | number | bigint, newValidator: string, estimateGas?: boolean): Promise<any>;
    transferNFTStakeHold(oldValidator: string, nftAddress: string, tokenId: string | number | bigint, holdTimestamp: number, newValidator: string, estimateGas?: boolean): Promise<any>;
    delegateNFT1155(validator: string, nftAddress: string, tokenId: string | number | bigint, amount: string | number | bigint, estimateGas?: boolean): Promise<any>;
    delegateNFT1155Hold(validator: string, nftAddress: string, tokenId: string | number | bigint, amount: string | number | bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    withdrawNFT1155(validator: string, nftAddress: string, tokenId: string | number | bigint, estimateGas?: boolean): Promise<any>;
    withdrawNFT1155Hold(validator: string, nftAddress: string, tokenId: string | number | bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    transferNFT1155Stake(oldValidator: string, nftAddress: string, tokenId: string | number | bigint, newValidator: string, estimateGas?: boolean): Promise<any>;
    transferNFT1155StakeHold(oldValidator: string, nftAddress: string, tokenId: string | number | bigint, holdTimestamp: number, newValidator: string, estimateGas?: boolean): Promise<any>;
    ...
    private buildMultiSigTxDelegateDRC721;
    private buildMultiSigTxDelegateDRC1155;
    private buildMultiSigTxTransferStakeToken;
    ...
    private decodeInnerTransaction;
    private decodeMultiSend;
    private decodeData;
    ...
    getNFTStake(nftAddress: string, tokenId: string | number | bigint, delegator: string, validator: string, holdTimestamp: number): Promise<NFTStake>;
    getNFTStakeId(nftAddress: string, tokenId: string | number | bigint, delegator: string, validator: string, holdTimestamp: number): Promise<string>;
