...
export default class Call {
    ...
    delegateNFT(validator: string, nftContract: string, tokenId: bigint, estimateGas?: boolean): Promise<any>;
    delegateNFTHold(validator: string, nftContract: string, tokenId: bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    delegateNFTByPermit(validator: string, nftContract: string, tokenId: bigint, sign: ethers.Signature, estimateGas?: boolean): Promise<any>;
    withdrawNFT(validator: string, nftContract: string, tokenId: bigint, estimateGas?: boolean): Promise<any>;
    withdrawNFTHold(validator: string, nftContract: string, tokenId: bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    transferNFTStake(oldValidator: string, nftContract: string, tokenId: bigint, newValidator: string, estimateGas?: boolean): Promise<any>;
    transferNFTStakeHold(oldValidator: string, nftContract: string, tokenId: bigint, holdTimestamp: number, newValidator: string, estimateGas?: boolean): Promise<any>;
    delegateNFT1155(validator: string, nftContract: string, tokenId: bigint, amount: bigint, estimateGas?: boolean): Promise<any>;
    delegateNFT1155Hold(validator: string, nftContract: string, tokenId: bigint, amount: bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    withdrawNFT1155(validator: string, nftContract: string, tokenId: bigint, estimateGas?: boolean): Promise<any>;
    withdrawNFT1155Hold(validator: string, nftContract: string, tokenId: bigint, holdTimestamp: number, estimateGas?: boolean): Promise<any>;
    transferNFT1155Stake(oldValidator: string, nftContract: string, tokenId: bigint, newValidator: string, estimateGas?: boolean): Promise<any>;
    transferNFT1155StakeHold(oldValidator: string, nftContract: string, tokenId: bigint, holdTimestamp: number, newValidator: string, estimateGas?: boolean): Promise<any>;
    ...
    createChecksDEL(signers: string[], amount: string | number | bigint, dueBlock: string | number | bigint, estimateGas?: boolean): Promise<any>;
    createChecksToken(signers: string[], amount: string | number | bigint, dueBlock: string | number | bigint, tokenAddress: string, sign?: ethers.Signature, estimateGas?: boolean): Promise<any>;
    redeemChecks(signatures: string[], checks: string[], callStatic?: boolean, estimateGas?: boolean): Promise<any>;
    ...
    getNFTStakeFromDelegation(nftContract: string, tokenId: bigint, delegator: string, validator: string, holdTimestamp: number): Promise<NFTStake>;
    getNFTStakeIdFromDelegation(nftContract: string, tokenId: bigint, delegator: string, validator: string, holdTimestamp: number): Promise<string>;
    getAvailableCoinAmount(validator: string, delegator: string, token: string, holdTimestamp: number): Promise<bigint>;
    getNFTBackedAmount(validator: string, delegator: string, token: string, holdTimestamp: number): Promise<bigint>;
