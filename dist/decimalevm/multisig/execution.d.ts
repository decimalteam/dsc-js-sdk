...
export declare const safeApproveHash: (signer: ethers.Wallet, safe: ethers.Contract, safeTx: SafeTransaction, skipOnChainApproval?: boolean, estimateGas?: boolean) => Promise<SafeSignature | BigNumberish>;
