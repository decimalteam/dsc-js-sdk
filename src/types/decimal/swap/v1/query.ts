...
export const QueryActiveSwapsRequest = {
  encode(_: QueryActiveSwapsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryActiveSwapsRequest>, I>>(_: I): QueryActiveSwapsRequest {
    const message = createBaseQueryActiveSwapsRequest();
    return message;
  },
};
...
export const QueryActiveSwapsResponse = {
  encode(message: QueryActiveSwapsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): QueryActiveSwapsResponse {
    return { swaps: Array.isArray(object?.swaps) ? object.swaps.map((e: any) => Swap.fromJSON(e)) : [] };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryActiveSwapsResponse>, I>>(object: I): QueryActiveSwapsResponse {
    const message = createBaseQueryActiveSwapsResponse();
