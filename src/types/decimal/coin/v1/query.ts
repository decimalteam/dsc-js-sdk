...
export const QueryCoinsRequest = {
  encode(message: QueryCoinsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCoinsRequest>, I>>(object: I): QueryCoinsRequest {
    const message = createBaseQueryCoinsRequest();
...
export const QueryCoinsResponse = {
  encode(message: QueryCoinsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCoinsResponse>, I>>(object: I): QueryCoinsResponse {
    const message = createBaseQueryCoinsResponse();
...
export const QueryCoinRequest = {
  encode(message: QueryCoinRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.denom !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCoinRequest>, I>>(object: I): QueryCoinRequest {
    const message = createBaseQueryCoinRequest();
...
export const QueryCoinResponse = {
  encode(message: QueryCoinResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCoinResponse>, I>>(object: I): QueryCoinResponse {
    const message = createBaseQueryCoinResponse();
...
export const QueryChecksRequest = {
  encode(message: QueryChecksRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryChecksRequest>, I>>(object: I): QueryChecksRequest {
    const message = createBaseQueryChecksRequest();
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageRequest.fromPartial(object.pagination)
      : undefined;
...
export const QueryChecksResponse = {
  encode(message: QueryChecksResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): QueryChecksResponse {
    return {
      checks: Array.isArray(object?.checks) ? object.checks.map((e: any) => Check.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryChecksResponse>, I>>(object: I): QueryChecksResponse {
    const message = createBaseQueryChecksResponse();
